...
import { HashRouter as Router, Routes, Route, useRoutes, useLocation, location, Navigate } from "react-router-dom";
  ...
  return (
    <Routes>
      ...
      <Route path="/lay" element={<LayoutFrame />}>
        ...
        <Route path="home" element={<div>Hello 7777</div>}></Route>
        <Route path="post/:slug" element={<div>Hello 6666</div>}></Route>
      </Route>
      <Route path="/about" element={<div>Hello about</div>} />
    </Routes>
  );
